...
//   if (
//     new Date(parseDate(pickedDate)).setHours(0, 0, 0, 0) == orderday &&
//     $(".sold").val() != undefined
//   ) {
...
function orderIt() {
  ...
  // not visible
  document.getElementById("total-price").innerHTML = parseFloat(
    Math.round(document.getElementById("number").innerHTML * 100) / 100
  ).toFixed(2);
  // visible
  if ($("#loginpop").attr("id") == undefined) {
    document.getElementById("unreal-total").innerHTML = parseFloat(
      Math.round(document.getElementById("number").innerHTML * 100) / 100
    )
      .toFixed(2)
      .replace(".", ",");
    ...
    document.getElementById("unreal-total").innerHTML = parseFloat(
      Math.round((document.getElementById("number").innerHTML - -fee) * 100) /
        100
    )
      .toFixed(2)
      .replace(".", ",");
...
$(".product").click(function() {
  ...
  document.getElementById("cart-badge").innerHTML =
    document.getElementById("cart-badge").innerHTML - -1;
...
$(document).on("click", ".fa-plus", function() {
  ...
  var price = $("#" + breadname)
    ...
    .text();
  document.getElementById("total-price").innerHTML = parseFloat(
    Math.round((total - -price) * 100) / 100
  ).toFixed(2);
  if ($("#loginpop").attr("id") == undefined) {
    document.getElementById("unreal-total").innerHTML = parseFloat(
      Math.round((total - -price) * 100) / 100
    ...
    document.getElementById("unreal-total").innerHTML = parseFloat(
      Math.round((total - -price - -0.46) * 100) / 100
    )
      .toFixed(2)
      .replace(".", ",");
  }
  ...
  document.getElementById("realnumber").innerHTML = document
...
$(document).on("click", ".fa-minus", function() {
  ...
  document.getElementById("number").innerHTML = e;
  document.getElementById("realnumber").innerHTML = e.replace(".", ",");
  if (document.getElementById("total-price").innerHTML == 0.0) {
...
function priceDiv() {
  document.getElementById("cart-price").innerHTML =
    document.getElementById("number").innerHTML.replace(".", ",") + " &#8364;";
}
